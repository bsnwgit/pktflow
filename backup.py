...
Keeps two snapshots alongside the project folder:
  ../pktFlow_backups/backup_1/  ← most recent
  ../pktFlow_backups/backup_2/  ← previous
...
then redeploy to O2 if applicable.
"""
...
# ── Project path ──────────────────────────────────────────────────────────────
PROJECT_DIR = Path(r"C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\pktFlow")
# ─────────────────────────────────────────────────────────────────────────────
