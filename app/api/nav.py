"""
pktFlow — Navigation manifest for pktHub's APPS sidebar.

Manifest: GET /api/nav/manifest  → this app's own left-nav, in display order

pktHub mirrors these entries under pktFlow in its own sidebar and opens each
...
NAV_MANIFEST = [
    {"path": "/",         "label": "Analytics",     "icon": "◑", "admin_only": False},
    {"path": "/devices",  "label": "Sources",       "icon": "◈", "admin_only": False},
    {"path": "/explorer", "label": "Flow Explorer", "icon": "⊕", "admin_only": False},
    {"path": "/geo",      "label": "Geo Map",       "icon": "◎", "admin_only": False, "divider_before": True},
    {"path": "/topology", "label": "Topology",      "icon": "⟳", "admin_only": False},
    {"path": "/radar",    "label": "Radar",         "icon": "◉", "admin_only": False},
    {"path": "/alerts",   "label": "Alerts",        "icon": "△", "admin_only": False, "divider_before": True},
    {"path": "/logs",     "label": "Logs",          "icon": "≡", "admin_only": False},
    {"path": "/settings", "label": "Settings",      "icon": "⚙", "admin_only": False, "divider_before": True},
]


@router.get("/nav/manifest")
