...
----------------------------------
Base HTTP client for pktflow acting as a suite-token CLIENT of a sibling
pkt* app (currently pktIPAM, for internal-IP lookups). Mirrors
pktIPAM's own app/integrations/suite_client.py (pktIPAM -> pktSNMP).
...
log = logging.getLogger("pktflow.integrations")


class SuiteClient:
    def __init__(self, base_url: str, suite_token: str, suite_user: str = "pktflow", suite_role: str = "admin"):
