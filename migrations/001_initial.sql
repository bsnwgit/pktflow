-- pktFlow SQLite initial migration
...
-- No placeholder devices are seeded — register real samplers via Settings → Devices.
...
VALUES (1,
    ...
    'Fires when a host not in the device registry sends NetFlow data',
    'new_host',
    '{}',
    'warning',
    '["inapp"]'
...
VALUES (2,
    'Collector data gap',
    'Fires when no flows are received from a known sampler for 10 minutes',
    'data_gap',
    '{"silence_minutes": 10}',
    'critical',
    '["inapp"]'
