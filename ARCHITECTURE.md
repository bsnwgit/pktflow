...
pktFlow is a purpose-built enterprise NetFlow visualization and alerting platform. It runs as an independent Python web service on the same EC2 as OpenObserve (`10.20.30.5`) but is completely isolated from it — own process, own storage, own port, no shared dependencies. Once live, the GoFlow2 collectors send NetFlow data exclusively to pktFlow; O2 is relieved of netflow duties entirely.
...
### Process Layout on EC2 (10.20.30.5)
