...
## Requirements
- Python 3.13: `C:\Users\robert.barnett\AppData\Local\Programs\Python\Python313\python.exe`
...
| O2 Server (OpenObserve) | 172.23.80.5 | ec2-user | C:\Users\robert.barnett\.ssh\VyneCorpNetInfra.pem               |
...
client.connect(
    "172.23.80.11",
    username="ec2-user",
    key_filename=r"C:\Users\robert.barnett\.ssh\VyneCorpNetInfra.pem",
    timeout=10
)
...
```
C:\Users\robert.barnett\AppData\Local\Programs\Python\Python313\python.exe C:\path\to\script.py
```
...
HOSTS = {
    ...
    "dental_collector": {
        "host": "10.56.57.181",
        "user": "ec2-user",
        "key": r"C:\Users\robert.barnett\.ssh\corporate_infrastructure.pem",
    },
    "o2_server": {
        "host": "172.23.80.5",
        "user": "ec2-user",
...
- NetFlow samplers: `192.168.44.7/8` → tagged `oneneck` | `172.27.28.89/88` → tagged `qts`
...
### O2 Server / OpenObserve (172.23.80.5)
- Uptime: 18 days
- Disk: 492GB at 37% used (173GB used on `/mnt/software`)
- Has `openobserve` and `openobserve-bkup` directories
- API endpoint: `http://172.23.80.5:5080`
- API auth: user `itops@vynecorp.com`
...
- O2 project scripts repo: `C:\Users\robert.barnett\My Drive\Documents\Claude\Projects\o2-scripts`
