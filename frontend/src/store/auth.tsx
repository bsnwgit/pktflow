...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Loaded through pkthub's proxy? pkthub attaches X-Suite-Token server-side,
    // so a fresh iframe context has no normal cookie/JWT session — check that
    // first and synthesize a logged-in user instead of falling through to login.
