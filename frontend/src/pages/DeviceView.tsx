...
import { axisProps, tooltipProps, gridProps, glow, INSTRUMENT , InstrumentFrame, RadialRing, FlowDefs, NodeRail , liveEdgeDot , LinePulseGradient } from '../components/instrument'
            ...
            <div className="space-y-6">
              <div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData} margin={{ top: 4, right: 8, left: 8, bottom: 4 }}>
                    <defs>
                      <LinePulseGradient id="f-pulse-bytes" color="#8ad8ea" />
                    ...
                    <Area type="monotone" dataKey="bytes" name="Bytes" stroke="url(#f-pulse-bytes)" style={glow("#8ad8ea", 5)}
              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData} margin={{ top: 4, right: 8, left: 8, bottom: 4 }}>
                    <defs>
                      <LinePulseGradient id="f-pulse-packets" color="#9784cb" />
                    ...
                    <Tooltip content={<TimeTooltip />} />
                    <Area type="monotone" dataKey="packets" name="Packets" stroke="url(#f-pulse-packets)" style={glow("#9784cb", 5)}
